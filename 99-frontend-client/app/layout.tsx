...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased flex h-screen overflow-hidden bg-slate-50 text-slate-900`}
      >
        ...
        <aside className="w-64 bg-slate-900 text-white hidden md:flex flex-col shadow-2xl h-screen flex-shrink-0 z-50">
          ...
          <nav className="mt-4 flex-1 px-2 space-y-1 overflow-y-auto pb-6">
            ...
            <Link href="/staff" className="flex items-center py-2.5 px-4 text-slate-400 hover:bg-slate-800 hover:text-white rounded-lg transition-colors"><span className="mr-3">👨‍💼</span><span className="font-medium text-sm">Staff Management</span></Link>
